...
public:
    ...
    ParameterInfo(string type, string name, string assemblyName, bool is_array = false);
...
public:
    ...
    void addParameter(string parameterType, string parameterName, string aname, bool isArray = false);
...
public:
    AssemblyInfo();
    string getAssemblyName();
    void setAssemblyName(string assemblyName, bool global = false, int arrayStarting = 0);
    bool isGlobal();
    void setArrayStarting(int n);
    int getArrayStarting();
    void addToTrueList(int newlabel);
    void addToFalseList(int newLabel);
    void addToNextList(int newLabel);
    string getLabel();
...
public:
    ...
    void addDeclaration(string name, string aname, bool isArray = false);
