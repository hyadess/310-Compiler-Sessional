...
public:
    ...
    bool Insert(string symbol_name, string symbol_type, ofstream &output)
    {
        ...
        if (check == true)
        {
            output << "\t"
                   << symbol_name
                   << " already exisits in the current ScopeTable" << endl;
            return false;
        }
...
public:
    ...
    bool Insert(string symbol_name, string symbol_type, ofstream &output)
    {
        return current_scope_table->Insert(symbol_name, symbol_type, output);
    }
    bool Delete(string symbol_name)
    {
